#ifndef PROJECT_GEODETIC_CONVERTER_H
#define PROJECT_GEODETIC_CONVERTER_H
...
/**
 * @brief Conversion between BLH, ENU, NED, ECEF
 */
namespace geodetic_converter
{
  ...
  public:
    ...
    void initialiseReference(const double latitude, const double longitude, const double altitude)
    {
      ...
      nRe(phiP, initial_longitude_, ecef_to_ned_mat_, 9);

      double ned_to_ecef_matrix_tmp[9];
      nRe(initial_latitude_, initial_longitude_, ned_to_ecef_matrix_tmp, 9);

      ned_to_ecef_mat_[0] = ned_to_ecef_matrix_tmp[0];
      ned_to_ecef_mat_[1] = ned_to_ecef_matrix_tmp[3];
      ned_to_ecef_mat_[2] = ned_to_ecef_matrix_tmp[6];
      ned_to_ecef_mat_[3] = ned_to_ecef_matrix_tmp[1];
      ned_to_ecef_mat_[4] = ned_to_ecef_matrix_tmp[4];
      ned_to_ecef_mat_[5] = ned_to_ecef_matrix_tmp[7];
      ned_to_ecef_mat_[6] = ned_to_ecef_matrix_tmp[2];
      ned_to_ecef_mat_[7] = ned_to_ecef_matrix_tmp[5];
      ned_to_ecef_mat_[8] = ned_to_ecef_matrix_tmp[8];
                  ...
                  double *down)
    {
      ...
      double vect_v[3];
      vect_v[0] = x - initial_ecef_x_;
      vect_v[1] = y - initial_ecef_y_;
      vect_v[2] = z - initial_ecef_z_;

      double ret_v[3];
      ret_v[0] = ecef_to_ned_mat_[0] * vect_v[0] + ecef_to_ned_mat_[1] * vect_v[1] + ecef_to_ned_mat_[2] * vect_v[2];
      ret_v[1] = ecef_to_ned_mat_[3] * vect_v[0] + ecef_to_ned_mat_[4] * vect_v[1] + ecef_to_ned_mat_[5] * vect_v[2];
      ret_v[2] = ecef_to_ned_mat_[6] * vect_v[0] + ecef_to_ned_mat_[7] * vect_v[1] + ecef_to_ned_mat_[8] * vect_v[2];
                  ...
                  double *z)
    {
      ...
      double ret_v[3];
      ret_v[0] = ned_to_ecef_mat_[0] * ned_v[0] + ned_to_ecef_mat_[1] * ned_v[1] + ned_to_ecef_mat_[2] * ned_v[2];
      ret_v[1] = ned_to_ecef_mat_[3] * ned_v[0] + ned_to_ecef_mat_[4] * ned_v[1] + ned_to_ecef_mat_[5] * ned_v[2];
      ret_v[2] = ned_to_ecef_mat_[6] * ned_v[0] + ned_to_ecef_mat_[7] * ned_v[1] + ned_to_ecef_mat_[8] * ned_v[2];

      *x = ret_v[0] + initial_ecef_x_;
      *y = ret_v[1] + initial_ecef_y_;
      *z = ret_v[2] + initial_ecef_z_;
    }
  ...
  private:
    inline void nRe(const double lat_radians, const double lon_radians, double *nReMat, int mat_length)
    {
    ...
    double ecef_to_ned_mat_[9];
    double ned_to_ecef_mat_[9];
...
#endif // PROJECT_GEODETIC_CONVERTER_H